export function calculateCareerToiAvg(toi1:string, toi2:string, gp1:number, gp2:number): string {
...
export function calculateCareerShootingPct(goals1: number, goals2: number, shots1: number, shots2:number): number {
...
export function calculateValuePer60(toi:string, value: number, gp: number): number {
